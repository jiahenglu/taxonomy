...
Given a bucket with the sum $S$ and the number of lengths is $n$, the maximal frequency is $M$. Suppose each element can join with other adjacent $\mu$ elements. 
