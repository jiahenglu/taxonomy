...
many applications, such as data integration and data cleansing. This paper investigates a novel challenge to integrate taxonomy with string joins. In principle, the taxonomy presents a general-purpose strategy to improve the accuracy of string joins by enriching data with semantics-based knowledge  (i.e., a set of IS-A hierarchies). For example,  ``\textsf{California}'' is a state of ``\textsf{U.S.}'' in a geographical taxonomy.
